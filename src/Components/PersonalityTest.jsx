  ...
  const questions = [
    {
      ...
      answerOptions: [
        {
          answerText: dictionary[language].personalityTestAnswer1,
          questionNumber: 1,
        },
        {
          answerText: dictionary[language].personalityTestAnswer2,
          questionNumber: 2,
        },
        {
          answerText: dictionary[language].personalityTestAnswer3,
          questionNumber: 3,
        },
        {
          answerText: dictionary[language].personalityTestAnswer4,
          questionNumber: 4,
        },
      ],
    },
          ...
          <>
            <div className="question-section">
              <div className="question-count">
                <span>PERSONALITY TEST {currentQuestion + 1}</span>/
                {questions.length}
              </div>
